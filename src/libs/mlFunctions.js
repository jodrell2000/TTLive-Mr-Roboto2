...
const mlFunctions = () => {
  return {
    ...
    suggestFollow: async function( playingArtist, playingTrack, roomFunctions, previousPlays = null ) {
      ...
      theQuestion += ` Tell me what interesting/alternative track you would play next to keep the vibe of the club going. Your reply MUST consist on ONLY correctly formatted JSON with two elements called artist and song with no additional comments. You must return an answer`;
